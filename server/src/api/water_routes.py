...
async def statistic_week(water_statistic_dto: WaterStatisticRequestDTO, service=Depends(
    get_water_service)):
    return service.statistic(water_statistic_dto, PeriodType.DAY)

@router.post("/statistic/week", response_model=list[WaterResponseDTO])
async def statistic_week(water_statistic_dto: WaterStatisticRequestDTO, service=Depends(
    get_water_service)):
    return service.statistic(water_statistic_dto, PeriodType.WEEK)

@router.post("/statistic/month", response_model=list[WaterResponseDTO])
async def statistic_week(water_statistic_dto: WaterStatisticRequestDTO, service=Depends(
    get_water_service)):
    return service.statistic(water_statistic_dto, PeriodType.MONTH)

@router.post("/statistic/year", response_model=list[WaterResponseDTO])
async def statistic_week(water_statistic_dto: WaterStatisticRequestDTO, service=Depends(
    get_water_service)):
    return service.statistic(water_statistic_dto, PeriodType.YEAR)
